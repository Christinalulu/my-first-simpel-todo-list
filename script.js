document.addEventListener("DOMContentLoaded", () => {
  ...
  const updateProgress = function (checkCompletion = true) {
    ...
    const precentage = totalTasks ? (completedTasks / totalTasks) * 100 : 0;
